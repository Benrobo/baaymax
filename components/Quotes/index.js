        ...
        <div className="w-full h-auto bg-dark-200 py-[50px]">
            <Container>
                <div className="head mx-auto flex flex-col items-center justify-center text-center md:items-center md:justify-start md:flex-row md:px-0">
                    <h1 className="text-[35px] font-bold md:mr-[50px]">Favorite Quote</h1>
                    <p className="text-[12px] text-white-200 ">My favorite motivational quote.</p>
                </div>
...
function QuoteCard() {
    ...
    return (
        <div id="t-box" className='relative w-full h-auto space-2 bg-dark-400 px-[30px] py-[20px] md:px-[80px] md:py-[50px] rounded-lg overflow-hidden'>
